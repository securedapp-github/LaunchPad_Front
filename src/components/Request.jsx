...
const Request = () => {
  return (
    <div className="bg-gradient-to-r from-stone-600 via-green-900 to-neutral-900 flex lg:flex-row flex-col ">
      ...
      <div className="flex justify-center items-center md:mb-0 mb-[50px]">
        <button className=" md:mt-[50px] mt-[25px] rounded-full py-2 px-8 border border-transparent text-black bg-gradient-to-r from-emerald-500 via-emerald-200 to-cyan-300 text-center font-sans md:text-2xl text-xl font-normal leading-normal">
